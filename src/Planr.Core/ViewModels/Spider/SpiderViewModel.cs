...
{
    public List<SpiderItem> Items { get; set; } = new();
    public List<SpiderDimension> Dimensions { get; set; } = new();
    public List<SpiderSeries> Series { get; set; } = new();
    public SpiderConfig Config { get; set; } = new();
    public double CenterValue { get; set; } = -1;
    public double MaxValue { get; set; } = 4;
}

public class SpiderDimension
{
...
public class SpiderSeries
{
    ...
    public List<SpiderPoint> Points { get; set; } = new();
}
