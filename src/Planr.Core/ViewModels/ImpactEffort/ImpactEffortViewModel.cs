...
{
  public List<MatrixQuadrant> Quadrants { get; set; } = [];
  public List<MatrixTask> Tasks { get; set; } = [];
...
public static class QuadrantHelper
{
  ...
  )
  {
    ...
    double rowsPerQuadrant = Math.Ceiling(totalTasksInQuadrant / colsPerQuadrant);
